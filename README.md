...
* **Примечание:** Максимальное значение на горизонтальной оси равно 500, а не 1001, потому что при использовании этой хэш-функции в хэш-таблицe использовался лишь один элемент из 1001. 
</details>
